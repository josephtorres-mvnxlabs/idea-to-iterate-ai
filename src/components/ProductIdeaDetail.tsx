          ...
          <div className="flex justify-between items-start">
            <div>
              <div className="flex gap-2 mb-2">
                ...
                <Badge variant="outline">{idea.priority} priority</Badge>
              </div>
        ...
        <CardFooter className="border-t pt-4 justify-between">
          <div className="text-sm text-muted-foreground">
            ...
            {idea.created_at !== idea.updated_at && (
              <span className="ml-4">Updated: {new Date(idea.updated_at).toLocaleDateString()}</span>
            )}
          </div>
          <div>
